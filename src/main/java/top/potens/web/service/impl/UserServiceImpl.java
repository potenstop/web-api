...
public class UserServiceImpl implements UserService {
    ...
    public UserMoreAuthBo queryById(@NotNull Integer userId) {
        AppLogger.info("按id查询user信息 userId:[{}]", String.valueOf(userId));
        ...
        AppLogger.info("按id查询user信息 成功返回 userId:[{}] result:[{}]", String.valueOf(userId), JSON.toJSONString(userMoreAuthBo));
