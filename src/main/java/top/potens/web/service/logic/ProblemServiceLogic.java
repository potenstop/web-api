...
public class ProblemServiceLogic {
    ...
    public void updateProblemTopic(List<AlbumCourseProblemTopic> updateAlbumCourseProblemTopicList, List<AlbumCourseProblemTopic> insertAlbumCourseProblemTopicList) {
